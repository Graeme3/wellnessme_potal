                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="_buttons">
                            ...
                            <a href="<?= admin_url('appointly/appointments/calendar'); ?>" id="calendarEl" class="btn btn-info pull-left display-block mleft10">
                                <?php echo 'Calender'; ?>
                            </a>

                            <!-- <?php echo form_open_multipart('appointly/appointments/uploadstaff', array('id' => 'appointment-form')); ?>
