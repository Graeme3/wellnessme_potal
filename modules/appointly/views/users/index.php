                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="<?= admin_url(APPOINTLY_MODULE_NAME . '/appointments/user_settings'); ?>" method="POST">
                                ...
                                echo '<hr>';
                                ?>
                                <?php if (is_admin() || staff_can('create', 'appointments')) { ?>
                                    ...
                                    <label for="appointly_default_table_filter" class="control-label font-medium"><?= _l('appointments_categories_heading'); ?></label>
                                    <hr>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label for="appointment_type" class="control-label"><?= _l('category_type_add_name_label'); ?></label>
